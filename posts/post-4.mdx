export const meta = {
  uid: `post-4`,
  title : `TIPS MUDIK GA PAKE RIBET`,
  description: `Waktunya kumpul kumpul ama keluarga`,
  cover: `https://images.unsplash.com/photo-1534732806146-b3bf32171b48?ixlib=rb-1.2.1&auto=format&fit=crop&w=600&q=80" width="100%`
}

# TIPS MUDIK GA PAKE RIBET

## Winter has come! Let's go out!!

<img src="https://images.unsplash.com/photo-1534732806146-b3bf32171b48?ixlib=rb-1.2.1&auto=format&fit=crop&w=1280&q=80" width="100%" caption="Lego Volkswagen Beetle by Atish Sewmangel (Unsplash)" />
